 ...
 class BD {
    ...
    static function SQL($sql) {
		try {
	        ...
	        if(self::$conn->error) {
			    die('[<strong style="color:#2B8C45"><span style="color:#DECC0B">LI</span>GA</strong>] <strong style="color:#ED5818">Error de SQL:</strong> <em>'.self::$conn->error."</em> con [<strong>$sql</strong>]<br />\n");
	        }
			...
			die('[<strong style="color:#2B8C45"><span style="color:#DECC0B">LI</span>GA</strong>] <strong style="color:#ED5818">Error de SQL:</strong> <em>'.$e->getMessage()."</em> con [<strong>$sql</strong>]<br />\n");
		}
    }
